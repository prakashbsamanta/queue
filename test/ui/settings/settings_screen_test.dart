...
void main() {
  ...
  testWidgets('SettingsScreen loads and saves settings', (WidgetTester tester) async {
    // Setup mock values
    when(mockBox.get('ai_api_key', defaultValue: anyNamed('defaultValue'))).thenReturn('old_key');
    when(mockBox.get('ai_provider', defaultValue: anyNamed('defaultValue'))).thenReturn('openai');
